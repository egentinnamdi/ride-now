...
import SuspendedAccountDetail from "./SuspendedAccountDetail";
import {
  Select,
  SelectContent,
  SelectGroup,
...
export default function SuspendedAccounts() {
  ...
  const [{ id, userType, show }, setSeeAccount] = useState<{
    id: string;
    userType: string;
    show: boolean;
  }>({ id: "", userType: "", show: false });

  function toggleDetail(id: string, userType?: string) {
    setSeeAccount((prev) => ({
      id,
